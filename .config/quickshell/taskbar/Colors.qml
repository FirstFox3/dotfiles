...
Singleton {
	...
	readonly property color on_primary_fixed: "#260e44"
	
	readonly property color on_primary_fixed_variant: "#533c72"
	...
	readonly property color primary_container: "#533c72"
	
	readonly property color primary_fixed: "#eddcff"
	
	readonly property color primary_fixed_dim: "#d7bafb"
	...
	readonly property color secondary_fixed_dim: "#cfc2da"
	
	readonly property color shadow: "#000000"
	
	readonly property color source_color: "#523678"
	...
	readonly property color surface_tint: "#d7bafb"
